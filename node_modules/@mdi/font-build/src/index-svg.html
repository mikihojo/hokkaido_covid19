...
<body>
    <h1>
        ...
        packageName
        <span class="date" id="date" style="display:none">January 0, 0000</span>
    </h1>
    ...
    <script type="text/javascript">
        ...
        function getIconItem(icon, isNewIcon, isDeprecatedIcon) {
            ...
            svg.onmouseup = function () {
                copyText(`<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="prefix-${icon.name}" width="24" height="24" viewBox="0 0 24 24"><g><path fill-opacity="0" d="M0,0H24V24H0" /><path d="${icon.data}" /></g></svg>`);
            };
        ...
        function getDate() {
            var date = null;
            if (date) {
                const local = new Date(Date.UTC(date.year, date.month, date.day, date.hour, date.minute, 0))
                const months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
                return `${months[local.getMonth()]} ${local.getDate()}, ${local.getFullYear()} ${formatAMPM(local)}`;
            }
            return '-';
        }
        (function () {
            ...
            if (newIconsCount === 0) {
                document.getElementById('newIconsHeader').style.display = 'none';
                document.getElementById('newIcons').style.display = 'none';
            }
